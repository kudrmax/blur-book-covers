...
aspect_ratio_x, aspect_ratio_y = 16, 9  # пропорции итогового изображение
...
for extension in ['jpg', 'jpeg', 'png', 'webp']:
    for in_name in glob.glob(input_image_directory + '*.' + extension):
        ...
        out_height, out_width = in_height, int(aspect_ratio_x * in_height / aspect_ratio_y)  # размеры того, что должно у нас получится на выходе
        ...
        out_image.paste(blured_image, (0, int(-out_height / 2)))  # вставляем заблюренную картинку в итоговую # ранее: out_image.paste(blured_image, (0, int(-blured_image.size[0] / 2)))
